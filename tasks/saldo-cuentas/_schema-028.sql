-- ════════════════════════════════════════════════════════════════════════════
-- 028 — El saldo se carga A MANO, por cuenta, una vez al día
--
-- DDL CANÓNICO. Ya corrido dos veces contra una base scratch con las
-- migraciones 001-027 aplicadas (menos la 021, ver §3 del plan). T01 lo copia
-- TAL CUAL como db/migrations/028_saldo_cuentas.sql, sin retipearlo.
--
...
-- `_verificacion-028.sql` #17 — porque "no puede pasar" es lo que se dice antes
